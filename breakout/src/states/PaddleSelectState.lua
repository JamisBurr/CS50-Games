...
function PaddleSelectState:update(dt)
    ...
    if love.keyboard.wasPressed('return') or love.keyboard.wasPressed('enter') then
        ...
        local bricks, needsKeyPowerup, keyPowerupBrickIndex, lockedBrickIndex = LevelMaker.createMap(1)
        ...
        gStateMachine:change('serve', {
            ...
            level = 1,
            recoverPoints = 5000,
            needsKeyPowerup = needsKeyPowerup,
            keyPowerupBrickIndex = keyPowerupBrickIndex,
            lockedBrickIndex = lockedBrickIndex
        })
    end

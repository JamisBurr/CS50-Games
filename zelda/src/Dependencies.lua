...
require 'src/states/entity/player/PlayerGrabPotState'
...
gTextures = {
    ...
    ['character-pot-grab'] = love.graphics.newImage('graphics/character_pot_lift.png'),
...
gFrames = {
    ...
    ['character-pot-grab'] = GenerateQuads(gTextures['character-pot-grab'], 16, 32),

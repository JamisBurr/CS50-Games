            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        local level = self.playerPokemon.level                 

                        gStateStack:push(BattleMessageState('Congratulations! You reached Level ' .. tostring(level) .. '!', 
                            function() end, false))

                        Timer.after(2, function()          
                            gStateStack:push(MenuState(self.battleState, self.playerPokemon:levelUp(),    
                            function()
                                -- pop battle message off
                                gStateStack:pop()
                                -- return to playstate
                                self:fadeOutWhite()
                            end))

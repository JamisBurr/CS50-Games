...
function PipePair:init(y)
    ...
    -- randomize the gap height between a minimum and maximum value
    local randomGAP_HEIGHT = math.random(MIN_GAP_HEIGHT, MAX_GAP_HEIGHT)    

    -- instantiate two pipes that belong to this pair
    self.pipes = {
        ['upper'] = Pipe('top', self.y),
        ['lower'] = Pipe('bottom', self.y + PIPE_HEIGHT + randomGAP_HEIGHT)
    }
